...
COMMAND_MAP = {
    ...
    "bgp_routes": {
        "cisco": "show ip bgp",
        "cisco_xe": "show ip bgp",
        "juniper_junos": "show route protocol bgp",
        "cisco_xr": "show ip bgp",
        "huawei_vrp": "display bgp routing-table",
        "nokia_sr": "show router bgp"
    },
    "mpls_interfaces": {
        "cisco": "show mpls interfaces",
        "cisco_xe": "show mpls interfaces",
        "juniper_junos": "show mpls interfaces",  # Adjust if needed.
